...
BOT_USERNAME = os.environ.get("BOT_USERNAME", "AnimeVaultXBot")
...
ABOUT_TXT = os.environ.get("ABOUT_MESSAGE", "<i><b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/AkMovieVerse>AkMovieVerse</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/Akmovieshubx>AkMoviesHubX</a>\n◈ ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/ak_ownerbot'>AK</a>\n◈ ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com/docs/'>ᴍᴏɴɢᴏ ᴅʙ</a>\n» ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/akmovieshubx'>AK</a></blockquote></b></i>")
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1002302070808"))
